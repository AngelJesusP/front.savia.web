...
import {
  CONTAINER_BOXSHADOW,
  CONTAINER_HEIGHT_BACKGROUND,
  Font_Montserrat,
} from "../../../utils/css/containerBackground";
...
export default class QueryRegister extends React.Component<{}, MyState> {
  ...
  render(): React.ReactNode {
    ...
    return (
      <div
        className="container-upload-file"
        style={CONTAINER_HEIGHT_BACKGROUND}
      >
        <div className="card m-4 border-0" style={CONTAINER_BOXSHADOW}>
          <div className="card-header bg-white">
            <span style={Font_Montserrat(true, 13, 12)}>
              ...
              <span
                style={{ color: "#AD0808", ...Font_Montserrat(false, 10, 12) }}
              >
            ...
            <div className="row w-100">
              <div className="col-3">
                ...
                <Select
                  ...
                  onChange={(e: any) =>
                    this.setState({ idEnfermedad: e.target.value })
                  }
              ...
              <div className="col-3">
                ...
                <Select
                  ...
                  optionFilterProp="children"
                  onChange={(e: any) =>
                    this.setState({ idIps: e.target.value })
                  }
              ...
              <div className="col-3">
                <span
                  className="w-100"
                  style={{ ...Font_Montserrat(true, 12, 15), ...SPAN }}
                >
                ...
                <Space direction="vertical" size={12}>
                  <RangePicker
                    ...
                    onChange={(e: any) => {
                      ...
                      if (e && e.length === 2)
                        this.setState({
                          desde: moment(e[0]).format("YYYY-MM-DD"),
                          hasta: moment(e[1]).format("YYYY-MM-DD"),
                        });
                    }}
